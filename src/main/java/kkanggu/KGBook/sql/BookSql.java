...
public class BookSql {
	public static String CREATE_BOOK = "INSERT INTO BOOK (title, author, publisher, publish_date, isbn, description) VALUES (?, ?, ?, ?, ?, ?);";
	...
	public static String SELECT_BOOKS_BY_TITLE = "SELECT * FROM BOOK WHERE title = ?";
}
