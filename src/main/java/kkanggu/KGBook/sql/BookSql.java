...
public class BookSql {
	public static String CREATE_BOOK = "INSERT INTO BOOK (id, title, author, publisher, publish_date, isbn," +
			"description, originImageUrl, s3ImageUrl) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);";
	public static String UPDATE_BOOK = "UPDATE BOOK SET title=?, author=?, publisher=?, publish_date=?, isbn=?," +
			"description=?, originImageUrl=?, s3ImageUrl=? WHERE id=?;";
