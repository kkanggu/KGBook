...
public class BookSql {
	public static String CREATE_BOOK = "INSERT INTO BOOK (isbn, title, author, publisher," +
			"original_price, discount_price, discount_rate, discount_type, publish_date, create_date," +
			"description, original_image_url, s3_image_url) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
	public static String UPDATE_BOOK = "UPDATE BOOK SET title=?, author=?, publisher=?," +
			"original_price=?, discount_price=?, discount_rate=?, discount_type=?," +
			"publish_date=?, description=? WHERE isbn=?;";
